...
Главное меняется из меню F5Voice → «Настройки»: сочетание клавиш (готовые
варианты или «Записать новое сочетание» — нажать нужные клавиши), стиль
плашки (Liquid Glass, Liquid Metal, прозрачное стекло, тёмная), пробел после
текста. Остальное — в файле. После правки файла: «Перечитать настройки». Ошибка в JSON или
