...
Значок в трее → «Настройки…»: сочетание клавиш (кнопка «Записать» — нажать
нужные клавиши), стиль плашки (glass, metal, light, dark; на Windows 11 стекло
и скруглённые углы через DWM, на Windows 10 плоская панель), языки, модель,
перенос строки, пробел после текста. Сохранение перезапускает F5Voice.
