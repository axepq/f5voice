...
стиль плашки (тёмный, светлый, графит — объёмная капсула с тенью; на Windows
это своё окно с настоящей прозрачностью, без зависимости от версии Windows),
языки, модель, перенос строки,
