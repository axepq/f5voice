...
в активное поле, Esc — отмена. Можно и удерживать сочетание: держишь дольше
трети секунды — запись до отпускания. Режим выбирается в окне («Запись»:
нажатие или удержание, только нажатие, только удержание). Первая фраза после
запуска ждёт загрузку модели.
...
режим записи, последние тридцать диктовок с кнопкой «Скопировать выбранное»,
...
| `record_mode` | `auto` — нажатие или удержание, `toggle` — только нажатие, `hold` — только удержание |
